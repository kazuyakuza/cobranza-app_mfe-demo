import { d as Ne, g as De, h as Oe } from "@nf-internal/chunk-72YGRQ3H";
import { a as G, d as ae } from "@nf-internal/chunk-PZNONLPT";
import * as h from "@angular/core";
import { \u0275RuntimeError as O, InjectionToken as L, inject as w, NgZone as Dt, DestroyRef as Ot, \u0275formatRuntimeError as kr, EnvironmentInjector as _t, runInInjectionContext as pe, DOCUMENT as Be, PendingTasks as Xe, untracked as _e, CSP_NONCE as At, \u0275TracingService as kt, makeEnvironmentProviders as It } from "@angular/core";
import { finalize as ze, concatMap as St, filter as Ft, map as q, switchMap as Ut } from "rxjs/operators";
import { Observable as ye, of as Je, from as Ct } from "rxjs";
var k = class e {
    headers;
...
function Ae(e) { return encodeURIComponent(e).replace(jt, (r, t) => Bt[t] ?? r); }
...
function ke(e) { return typeof ArrayBuffer < "u" && e instanceof ArrayBuffer; }
...
var W = "Content-Type", te = "Accept", Ve = "text/plain", $e = "application/json", Ge = `${$e}, ${Ve}, */*`, X = class e {
    ...
    serializeBody() { return this.body === null ? null : typeof this.body == "string" || ke(this.body) || Ie(this.body) || Se(this.body) || zt(this.body) ? this.body : this.body instanceof F ? this.body.toString() : typeof this.body == "object" || typeof this.body == "boolean" || Array.isArray(this.body) ? JSON.stringify(this.body) : this.body.toString(); }
    detectContentTypeHeader() { return this.body === null || Se(this.body) ? null : Ie(this.body) ? this.body.type || null : ke(this.body) ? null : typeof this.body == "string" ? Ve : this.body instanceof F ? "application/x-www-form-urlencoded;charset=UTF-8" : typeof this.body == "object" || typeof this.body == "number" || typeof this.body == "boolean" ? $e : null; }
    ...
    doRequest(t, n, o) { return ae(this, null, function* () { let s = this.createRequestInit(t), i; try {
        ...
        this.maxResponseSize !== null && Number.isFinite(l) && l > this.maxResponseSize && Fe(this.maxResponseSize);
        ...
        if (yield this.ngZone.runOutsideAngular(() => ae(this, null, function* () { for (;;) {
            ...
            if (I)
                break;
            if (p.push(B), x += B.length, this.maxResponseSize !== null && x > this.maxResponseSize && (yield v.cancel(), Fe(this.maxResponseSize)), T) {
                M = t.responseType === "text" ? (M ?? "") + (y ??= Ue(g)).decode(B, { stream: !0 }) : void 0;
    ...
    } u === 0 && (u = f ? ge : 0); let b = u >= 200 && u < 300, R = i.redirected, P = i.type; b ? (o.next(new C({ body: f, headers: c, status: u, statusText: a, url: d, redirected: R, responseType: P })), o.complete()) : o.error(new _({ error: f, headers: c, status: u, statusText: a, url: d, redirected: R, responseType: P })); }); }
    parseBody(t, n, o, s) { switch (t.responseType) {
        ...
        case "text": return Ue(o).decode(n);
...
function ue() { }
function Gt(e) { e.then(ue, ue); }
function Fe(e) { throw new O(-2825, !1); }
var Wt = /charset=\s*["']?([^;"'\s]+)["']?/i;
function Ue(e) { let r = e.match(Wt); if (r !== null)
    try {
        return new TextDecoder(r[1]);
    }
    catch { } return new TextDecoder; }
var me = new L("", { factory: () => !0 }), Ye = "XSRF-TOKEN", Ze = new L("", { factory: () => Ye }), qe = "X-XSRF-TOKEN", Qe = new L("", { factory: () => qe }), He = (() => { class e {
    cookieName = w(Ze);
    doc = w(Be);
    lastCookieString = "";
    lastToken = null;
...
function we(e, r) { if (!w(me) || e.method === "GET" || e.method === "HEAD")
    return r(e); try {
    let o = w(Ne).href, { origin: s } = new URL(o), { origin: i } = new URL(e.url, s);
    if (s !== i)
        return r(e);
}
catch {
    return r(e);
} let t = w(Te).getToken(), n = w(Qe); return t != null && !e.headers.has(n) && (e = e.clone({ headers: e.headers.set(n, t) })), r(e); }
var Ce = (() => { class e {
    injector = w(_t);
    intercept(t, n) { return pe(this.injector, () => we(t, o => n.handle(o))); }
    static \u0275fac = function (n) { return new (n || e); };
...
function Yt(e, r, t) { return (n, o) => pe(t, () => r(n, s => e(s, o))); }
var ve = new L(""), Y = new L("", { factory: () => [we] }), be = new L(""), Ee = new L("", { factory: () => !0 });
function Zt() { let e = null; return (r, t) => { e === null && (e = (w(ve, { optional: !0 }) ?? []).reduceRight(Kt, et)); let n = w(Xe); if (w(Ee)) {
    let s = n.add();
...
var re = (() => { class e {
    ...
    chain = null;
    pendingTasks = w(Xe);
    contributeToStability = w(Ee);
    constructor(t, n) { this.backend = t, this.injector = n; }
    handle(t) { if (this.chain === null) {
        let o = this.injector.get(Z, null, { skipSelf: !0 }), s = o !== null && this.backend === o, i = this.injector.get(be, [], s ? { self: !0 } : void 0), c = Array.from(new Set([...this.injector.get(Y), ...i]));
        ...
        return _e(() => n(t, s => this.backend.handle(s))).pipe(ze(o));
    }
    else
...
var Pe = (() => { class e {
    ...
    handle(t) { if (t.method !== "JSONP")
        ...
        return;
    } n.next(new C({ body: c, status: ge, statusText: "OK", url: s })), n.complete(); }); }, f = T => { d(), n.error(new _({ error: T, status: 0, statusText: "JSONP Error", url: s })); }; return i.addEventListener("load", u), i.addEventListener("error", f), this.document.body.appendChild(i), n.next({ type: A.Sent }), () => { a || this.removeListeners(i), d(); }; }); }
...
function tt(e, r) { return e.method === "JSONP" ? w(Pe).handle(e) : r(e); }
var er = (() => { class e {
    injector;
    constructor(t) { this.injector = t; }
    intercept(t, n) { return pe(this.injector, () => tt(t, o => n.handle(o))); }
...
function rt(...e) { let r = [Re, J, re, { provide: Z, useExisting: re }, { provide: V, useFactory: () => w(J) }, { provide: Y, useValue: we, multi: !0 }]; for (let t of e)
...
function fe({ cookieName: e, headerName: r }) { let t = []; return e !== void 0 && t.push({ provide: Ze, useValue: e }), r !== void 0 && t.push({ provide: Qe, useValue: r }), j(U.CustomXsrfConfiguration, t); }
function ot() { return j(U.NoXsrfProtection, [{ provide: me, useValue: !1 }]); }
function st() { return j(U.JsonpSupport, [Pe, { provide: ne, useFactory: Ht }, { provide: Y, useValue: tt, multi: !0 }]); }
...
function it() { return j(U.Xhr, [he, { provide: V, useExisting: he }]); }
var sr = (() => { class e {
    ...
    static \u0275inj = h.\u0275\u0275defineInjector({ providers: [Ce, { provide: ve, useExisting: Ce, multi: !0 }, { provide: Te, useClass: He }, fe({ cookieName: Ye, headerName: qe }).\u0275providers, { provide: me, useValue: !0 }] });
} return e; })(), ir = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275mod = h.\u0275\u0275defineNgModule({ type: e });
...
function qr(e) { return [{ provide: se, useFactory: () => (dr("NgHttpTransferCache"), G({ isCacheActive: !0 }, e)) }, { provide: be, useValue: vr, multi: !0 }, { provide: cr, multi: !0, useFactory: () => { let r = $(lr), t = $(se); return () => { r.whenStable().then(() => { t.isCacheActive = !1; }); }; } }]; }
...
} }; return new Me(o, d => _r(d, t, e), n?.defaultValue, n?.debugName, n?.parse, n?.equal, a); }; }
...
var Me = class extends fr {
    ...
    constructor(r, t, n, o, s, i, c) { super(t, ({ params: a, abortSignal: d }) => { let u, f = !1, T = () => { f = !0, u?.unsubscribe(); }; d.addEventListener("abort", T); let b = ft({ value: void 0 }), R, P = new Promise(m => R = m), g = m => { b.set(m), R?.(b), R = void 0; }; return u = this.client.request(a).subscribe({ next: m => { switch (m.type) {
            ...
            case A.DownloadProgress:
                ...
                break;
        } }, error: m => { m instanceof _ && (this._headers.set(m.headers), this._statusCode.set(m.status)), g({ error: m }), d.removeEventListener("abort", T); }, complete: () => { R && g({ error: new ht(991, !1) }), d.removeEventListener("abort", T); } }), f && u.unsubscribe(), P; }, n, i, o, r, void 0, c), this.client = r.get(Re); }
    set(r) { super.set(r), this._headers.set(void 0), this._progress.set(void 0), this._statusCode.set(void 0); }
};
export { J as FetchBackend, ve as HTTP_INTERCEPTORS, pt as HTTP_TRANSFER_CACHE_ORIGIN_MAP, V as HttpBackend, Re as HttpClient, ar as HttpClientJsonpModule, ir as HttpClientModule, sr as HttpClientXsrfModule, H as HttpContext, de as HttpContextToken, _ as HttpErrorResponse, A as HttpEventType, U as HttpFeatureKind, Z as HttpHandler, K as HttpHeaderResponse, k as HttpHeaders, F as HttpParams, X as HttpRequest, C as HttpResponse, z as HttpResponseBase, We as HttpStatusCode, ee as HttpUrlEncodingCodec, he as HttpXhrBackend, Te as HttpXsrfTokenExtractor, Pe as JsonpClientBackend, er as JsonpInterceptor, Qr as httpResource, rt as provideHttpClient, or as withFetch, rr as withInterceptors, nt as withInterceptorsFromDi, st as withJsonpSupport, ot as withNoXsrfProtection, nr as withRequestsMadeViaParent, it as withXhr, fe as withXsrfConfiguration, Ke as \u0275HTTP_FETCH_MAX_RESPONSE_SIZE, be as \u0275HTTP_ROOT_INTERCEPTOR_FNS, re as \u0275HttpInterceptingHandler, Ee as \u0275REQUESTS_CONTRIBUTE_TO_STABILITY, qr as \u0275withHttpTransferCache };
